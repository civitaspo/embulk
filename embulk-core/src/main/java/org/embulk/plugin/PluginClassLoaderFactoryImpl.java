...
public class PluginClassLoaderFactoryImpl implements PluginClassLoaderFactory {
    ...
    public static PluginClassLoaderFactoryImpl of(
            ...
            final Collection<String> parentFirstPackages,
            final Collection<String> parentFirstResources) {
        // Set plugins.class_loaders.hold = true to hold created PluginClassLoader instances in memory.
        final boolean hold = embulkSystemProperties.getPropertyAsBoolean("plugins.class_loaders.hold", true);
    ...
    public void clear() {
        ...
        /*
        for (final PluginClassLoader pluginClassLoader : this.createdPluginClassLoaders.keys()) {
